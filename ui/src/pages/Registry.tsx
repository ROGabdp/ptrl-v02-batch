                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {models.map((row, idx) => (
                                    <tr key={`${row.run_id}-${row.ticker}-${idx}`} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 font-mono">{row.run_id.substring(0, 8)}...</td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <Link to={`/runs/${row.run_id}`} className="text-indigo-600 hover:text-indigo-900">Variables</Link>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
